        ...
        <div class="grid grid-rows-4 grid-cols-3 grid-flow-col gap-8 h-[600px]">
            ...
            <div class="grid grid-cols-3 gap-6 h-full w-full">
              ...
              <CardDetailInfo>
                <div class="flex flex-col justify-center items-center w-full h-full">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 24 24"><path fill="#171717" d="M12 21.5q-3.325 0-5.662-2.312Q4 16.875 4 13.6q0-1.65.613-3.063q.612-1.412 1.737-2.487L12 2.5l5.65 5.55q1.125 1.075 1.738 2.487Q20 11.95 20 13.6q0 3.275-2.337 5.588Q15.325 21.5 12 21.5Zm0-16.2L7.75 9.5q-.75.725-1.188 1.6q-.437.875-.537 1.925h11.95q-.1-1.05-.537-1.925q-.438-.875-1.188-1.6Z"/></svg>
                  <div class="flex justify-center pt-2 gap-10 text-2xl w-ful">
                    <div class="flex items-center gap-1">
                      <span>50%</span>
                    </div>
          ...
          <CardInfo class="row-span-2 col-span-2 p-6">
            <div class="grid grid-cols-2 gap-6 h-full w-full">
              ...
              <CardDetailInfo>
                <div class="flex flex-col justify-center items-center w-full h-full">
                  <span class="text-2xl">Water pump</span>
                  <div class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 24 24"><path fill="currentColor" d="M19 14.5s2 2.17 2 3.5a2 2 0 0 1-2 2a2 2 0 0 1-2-2c0-1.33 2-3.5 2-3.5M5 18V9a2 2 0 0 1-2-2a2 2 0 0 1 2-2V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1h8a2 2 0 0 1 2 2v4a1 1 0 0 1 1 1a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1a1 1 0 0 1 1-1V9h-6v9h1a2 2 0 0 1 2 2v2H2v-2a2 2 0 0 1 2-2h1Z"/></svg>
                    <div class="flex justify-center pt-2 gap-10 text-2xl w-ful">
                      <div class="flex items-center gap-1">
                        <span>  </span>
                      </div>
              ...
              <CardDetailInfo>
                <div class="flex flex-col justify-center items-center w-full h-full">
                  ...
                  <div class="flex">
                    <div @click="lightStatus = !lightStatus">
                      <svg v-if="!lightStatus" xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 24 24"><path fill="currentColor" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74c0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-2.3l-.85-.6A4.997 4.997 0 0 1 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.63-.8 3.16-2.15 4.1z"/></svg>
                      <svg v-else xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 24 24"><path fill="currentColor" d="M12 6a6 6 0 0 1 6 6c0 2.22-1.21 4.16-3 5.2V19a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-1.8c-1.79-1.04-3-2.98-3-5.2a6 6 0 0 1 6-6m2 15v1a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1h4m6-10h3v2h-3v-2M1 11h3v2H1v-2M13 1v3h-2V1h2M4.92 3.5l2.13 2.14l-1.42 1.41L3.5 4.93L4.92 3.5m12.03 2.13l2.12-2.13l1.43 1.43l-2.13 2.12l-1.42-1.42Z"/></svg>
                    </div>
                    <div class="flex justify-center pt-2 gap-10 text-2xl w-ful">
                      <div class="flex items-center gap-1">
                        <span>  </span>
...
const wifi = ref('ICOFFE');
const state = ref('Manual');
...
//   clientId: 'clientID - ' + (Math.random() * 100),
//   // auth
//   username: 'test_26_11',
//   password: 'nam12345',
// })
